...
[bits 16]
    ...
    %include "sorcecode/asm_kernel/bootloader/memory_maper.asm"
    ...
    %include "sorcecode/asm_kernel/bootloader/kernel_64.asm"

    ;jmp INI_KERNEL
    ;;


%include "sorcecode/asm_kernel/bootloader/vars.asm"

%include "sorcecode/asm_kernel/bootloader/a20_high_memory.asm"
%include "sorcecode/asm_kernel/bootloader/gdt.asm"
